 ...
 * @author Guiro
 */
@WebServlet(name = "EventList", urlPatterns = {"/list"})
public class EventList extends HttpServlet {
    ...
    */
    ...
    final String VUE_LIST = "event/eventList.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(request.getSession().getAttribute("user_id") != null){
            EventDOA event_doa;
            int id_own = Integer.parseInt(request.getSession().getAttribute("user_id").toString());
            System.out.print(id_own);
            try {
		event_doa = new EventDOA();
		List<Event> events = event_doa.getEvents(id_own);
